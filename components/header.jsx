  ...
  return (
    <>
      <div className="h-[580px] relative flex justify-end">
        <Image src={"/beachImage.jpg"} alt="background" width={600} height={600} className="" />
        <div className="absolute left-1/2 -translate-x-1/2 bottom-[40px] bg-slate-100 bg-transparent">
          <p className="font-bold text-[52px] w-[509px] text-slate-900">Find The Best Place to Stress Release</p>
          <p className="text-[16px] w-[350px] text-slate-600">A new way to travel by air the easy and fast way. 
